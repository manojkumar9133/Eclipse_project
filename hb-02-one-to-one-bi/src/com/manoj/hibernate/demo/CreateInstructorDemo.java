...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			Instructor tempInstructor=new Instructor("man","speed","speed@gmail.com");
			
			//create a instructor details object
			InstructorDetails tempInstructorDetails=new InstructorDetails("https://youtube.com/speed","very funny");
